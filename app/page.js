...
export default function Home() {
  return (
    <main className="min-h-screen h-auto flex flex-col items-center">
      ...
      <div className="w-11/12 flex flex-col items-center mt-6 mb-6 sm:flex-wrap sm:flex-row">
        <Link href={'/'} className="bg-[#393d3f] border-2  border-black w-[300px] h-[250px] flex flex-col items-center rounded-lg m-3">
        ...
        <Link href={'/about_me'} className="bg-[#393d3f] border-2  border-black w-[300px] h-[250px] flex flex-col items-center rounded-lg m-3">
        ...
        <Link href={'/'} className="bg-[#393d3f] border-2  border-black w-[300px] h-[250px] flex flex-col items-center rounded-lg m-3">
          <h2 className="h-1/4 font-bold text-2xl text-white">Background</h2>
          <Image className="h-3/4" src="/landing/cv.png" alt="Juan Carlos Rivera Alvarado" width={200} height={200} />
        </Link>
        <Link href={'/skills'} className="bg-[#393d3f] border-2  border-black w-[300px] h-[250px] flex flex-col items-center rounded-lg m-3">
